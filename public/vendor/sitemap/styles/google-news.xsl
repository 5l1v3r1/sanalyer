...
.url:hover
{
  ...
  <body>
	<div id="content">
		...
		<p class="expl">Generated by <a href="https://www.radkod.com/" target="_blank" title="Freelance Web Tasarım">RadKod</a>. This is styled version xml sitemap (for Google News), sorted by update date.</p>
