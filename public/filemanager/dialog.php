	...
	<div class="span12">
		...
		foreach ($files as $file_array) {
			...
			foreach ($files as $nu=>$file_array) {
                ...
                $newFilename = $filename.'-image(122x90-crop)';
                $fileSmall = env('APP_URL').'/resimler/'.$newFilename.".".$file_array['extension'];
            ?>
			...
			?>		<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<div class="img-precontainer">
					...
					<div class="img-container">
						<img class="<?php echo $show_original ? "original" : "" ?><?php echo $is_icon_thumb ? " icon" : "" ?>" data-src="<?php echo $fileSmall; ?>">
					</div>
				</div>
