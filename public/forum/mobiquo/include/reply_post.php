...
function reply_post_func($xmlrpc_params)
{
    ...
    {
        switch ($spamModel->checkMessageSpam($data['subject'] . "\n" . $data['text_body'], array(), $bridge->_request))
        {
            ...
            case XenForo_Model_SpamPrevention::RESULT_DENIED;
                ...
                $bridge->responseError(new XenForo_Phrase('your_content_cannot_be_submitted_try_later'));
                break;
        }
    }
	...
	Tapatalk_Push_Push::tapatalk_push_reply('AddReply', $post, $thread);
