    ...
    foreach($conversations as $conversation)
    {
        ...
        foreach($recipients as $uid => $recipient)
        {
            $participants[$uid] = new xmlrpcval(array(
                'username'  => new xmlrpcval(empty($recipient['username']) ? new XenForo_Phrase('unknown_member') : $recipient['username'], 'base64'),
        ...
        $conversation_list[] = new xmlrpcval(array(
            ...
            'start_timestamp'   => new xmlrpcval($conversation['start_date'],'string'),
