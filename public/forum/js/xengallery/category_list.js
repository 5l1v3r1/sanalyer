...
{
	XenForo.CategoryList = function($element) { this.__construct($element); };
	XenForo.CategoryList.prototype =
	{
		__construct: function($element)
		{
			$element.sapling();

			if ($element.data('liststyle') == 'collapsibleExpanded')
			{
				$element.data('sapling').expand();
			}
		}
	}

	XenForo.register('.CategoryList', 'XenForo.CategoryList');
}
