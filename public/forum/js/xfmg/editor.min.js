...
b=b.data("id");b=e+"-"+b;d.hasOwnProperty(b)||(d[b]=1,b=c.find(".js-tabCounter"),this.tabCounts[a]+=1,b.text(this.tabCounts[a]),f.val(JSON.stringify(d)))},unchecked:function(a,c){a.removeClass("is-selected");c=a.closest("ul > li.is-active");c=this.$container.find(c.data("tab"));var b=c.attr("id"),d=this.$container.find(".js-embedValue"),e=JSON.parse(d.val()),f=a.data("type");a=a.data("id");a=f+"-"+a;e.hasOwnProperty(a)&&(delete e[a],a=c.find(".js-tabCounter"),--this.tabCounts[b],this.tabCounts[b]?
a.text(this.tabCounts[b]):(a.text(0),c.removeClass("has-selected")),d.val(JSON.stringify(e)))},submit:function(a){a.preventDefault();a=this.ed;var b=this.overlay,c=this.$container.find(".js-embedValue");c=JSON.parse(c.val());var d="",e;for(e in c)if(c.hasOwnProperty(e)){var h=e.split("-");d+=XF.htmlspecialchars("[GALLERY="+h[0]+", "+parseInt(h[1])+"][/GALLERY]");d+="<p><br></p>"}a.selection.restore();a.html.insert(d);b.hide()}})},callback:function(){XF.EditorHelpers.loadDialog(this,"gallery")}};a(c).on("editor:first-start",
