...
class XenGallery_Listener
{
	...
	{
		XenForo_Model_Import::$extraImporters[] = 'XenGallery_Importer_IPGallery34x';
		XenForo_Model_Import::$extraImporters[] = 'XenGallery_Importer_IPGallery40x';
		XenForo_Model_Import::$extraImporters[] = 'XenGallery_Importer_IPGallery41x';
