<?php
class Brivium_Tellurium_Model_Icon extends XenForo_Model
{
	...
	protected static function _applyIcon($node, $upload, $number, $nodeType)
	{
		...
		switch($nodeType)
		{
			case 'forum':
				...
				$dwData = array(
					'brt_icon_date_'.$number => XenForo_Application::$time,
					'brt_select' => 'file'
				);
				break;
			case 'page':
				...
				$dwData = array(
					'brt_icon_date' => XenForo_Application::$time,
					'brt_select' => 'file'
				);
				break;
			case 'link':
