<?php
class Brivium_Tellurium_EventListeners_Listener extends Brivium_BriviumHelper_EventListeners
{
	public static function widgetFrameworkReady(&$renderers)
	{
		if(!in_array('Brivium_Tellurium_WidgetRenderer_Tellurium',$renderers)){
			$renderers[] = 'Brivium_Tellurium_WidgetRenderer_Tellurium';
		}
	}
	...
	{
		XenForo_Template_Helper_Core::$helperCallbacks['nodeicon'] = array('Brivium_Tellurium_EventListeners_Helpers', 'helperGetCustomIcon');
