...
class Brivium_Tellurium_ControllerAdmin_Page extends XFCP_Brivium_Tellurium_ControllerAdmin_Page
{
	...
	public function actionIcon()
	{
		...
		if ($nodeId && $nodeType = $this->_getNodeModel()->getNodeTypeByNodeId($nodeId))
		{
			...
			return $this->responseView('Brivium_Tellurium_ViewAdmin_Node_Avatar', 'BRQCT_node_icon_page', $viewParams);
		}
		else
		{
