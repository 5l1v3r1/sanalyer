...
class Brivium_Tellurium_ControllerAdmin_Forum extends XFCP_Brivium_Tellurium_ControllerAdmin_Forum
{
	...
	public function brqctSave($writer)
	{
		...
		$default = $this->_input->filter(array(
			'brt_url_1' => XenForo_Input::STRING,
			'brt_url_2' => XenForo_Input::STRING
		));
	...
	public function actionIcon()
	{
		...
		if ($nodeId && $nodeType = $this->_getNodeModel()->getNodeTypeByNodeId($nodeId))
		{
			...
			return $this->responseView('Brivium_Tellurium_ViewAdmin_Node_Avatar', 'BRQCT_node_icon', $viewParams);
		}
		else
		{
