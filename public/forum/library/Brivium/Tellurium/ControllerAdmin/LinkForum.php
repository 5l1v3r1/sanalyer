...
class Brivium_Tellurium_ControllerAdmin_LinkForum extends XFCP_Brivium_Tellurium_ControllerAdmin_LinkForum
{
	...
	public function actionIcon()
	{
		...
		if ($nodeId && $nodeType = $this->_getNodeModel()->getNodeTypeByNodeId($nodeId))
		{
			...
			return $this->responseView('Brivium_Tellurium_ViewAdmin_Node_Avatar', 'BRQCT_node_icon_link', $viewParams);
		}
		else
		{
