<?php
class Brivium_QuickCreateThread_ControllerPublic_Index extends XenForo_ControllerPublic_Abstract
{
	public function actionIndex()
	{
        ...
        return $this->responseView('Brivium_QuickCreateThread_ViewPublic_Create', 'BRQCT_create_form', $viewParams);
	}
	...
	public function actionBRQCT()
	{
		...
		return $this->responseView('Brivium_QuickCreateThread_ViewPublic_CreateThread', 'BRQCT_quick_thread_create', $viewParams);
	}
