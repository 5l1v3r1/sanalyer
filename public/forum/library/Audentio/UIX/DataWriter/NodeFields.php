...
class Audentio_UIX_DataWriter_NodeFields extends XenForo_DataWriter
{
    protected function _getFields()
    {
        ...
        $fields['uix_node_fields']['inheritClass'] = array('type' => self::TYPE_BOOLEAN, 'default' => 0);
    ...
    protected function _postSave()
    {
        ...
        if ($this->isInsert() || $this->isChanged('uix_styling') || $this->isChanged('inheritClass')) {
            $this->getModelFromCache('XenForo_Model_Node')->rebuildNodeStylingCache();
