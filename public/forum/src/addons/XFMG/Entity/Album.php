 ...
 * @property \XFMG\Entity\SharedMapAdd[] SharedMapAdd
 * @property \XFMG\Entity\SharedMapView[] SharedMapView
 * @property \XF\Entity\ApprovalQueue ApprovalQueue
 * @property \XFMG\Entity\AlbumWatch[] Watch
 ...
 * @property \XFMG\Entity\AlbumCommentRead[] CommentRead
...
class Album extends Entity
{
	...
	public function canView(&$error = null)
	{
		...
		{
			if (
				!$this->hasPermission('viewModeratedAlbum')
	...
	public function canChangePrivacy(&$error = null)
	{
		...
		if ($this->user_id == $visitor->user_id && $this->hasPermission('changePrivacyOwnAlbum'))
		{
			return true;
		}
	...
	{
		$visitor = \XF::visitor();
		return ($visitor->user_id && $this->hasPermission('inlineModAlbum'));
	}
	...
	public static function getStructure(Structure $structure)
	{
		...
		$structure->columns = [
			...
			'view_privacy' => ['type' => self::STR, 'default' => 'private', 'nullable' => true,
				'allowedValues' => ['public', 'members', 'private', 'shared', 'inherit']
			],
		...
		$structure->behaviors = [
			...
			'XF:Likeable' => ['stateField' => 'album_state']
		];
		$structure->relations = [
			'Category' => [
