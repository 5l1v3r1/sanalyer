...
class Album extends AbstractController
{
	...
	public function actionView(ParameterBag $params)
	{
		$album = $this->assertViewableAlbum($params->album_id, [
			'DraftComments|' . \XF::visitor()->user_id, 'Category'
		]);
	...
	public function actionUndelete(ParameterBag $params)
	{
		...
		else
		{
			...
			return $this->view('XFMG:Album\Undelete', 'xfmg_album_undelete', $viewParams);
		}
	}
	...
	public function actionLike(ParameterBag $params)
	{
		...
		return $likePlugin->actionToggleLike(
			$album,
			$this->buildLink('media/albums/like', $album),
			$this->buildLink('media/albums', $album),
			$this->buildLink('media/albums/likes', $album)
		);
	}
	...
	public function actionLikes(ParameterBag $params)
	{
		...
		$breadcrumbs = $album->getBreadcrumbs();
		$title = \XF::phrase('xfmg_members_who_liked_album', ['title' => $album->title]);
