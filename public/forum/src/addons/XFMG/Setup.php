...
class Setup extends AbstractSetup
{
	...
	public function upgrade2000070Step3()
	{
		$this->schemaManager()->alterTable('xengallery_media', function(Alter $table)
		{
			...
			$table->addColumn('media_privacy', 'enum')->values(['private', 'public', 'shared', 'members', 'followers'])->setDefault('public')->after('album_id');
			...
			$table->changeColumn('media_privacy')->values(['private', 'public', 'shared', 'members', 'followed', 'category']);
			$table->renameColumn('xengallery_category_id', 'category_id');
	...
	{
		$db = $this->db();
		$db->update('xf_attachment', ['unassociated' => 1], 'content_type = ?', 'xfmg_media');
	}
	...
	protected function applyDefaultPermissions($previousVersion = null)
	{
		...
		if (!$previousVersion)
		{
			...
			$this->applyGlobalPermission('xfmg', 'like', 'forum', 'like');
			$this->applyGlobalPermission('xfmg', 'rate', 'forum', 'like');
			...
			$this->applyGlobalPermission('xfmg', 'likeAlbum', 'forum', 'like');
			$this->applyGlobalPermission('xfmg', 'rateAlbum', 'forum', 'like');
			...
			$this->applyGlobalPermission('xfmg', 'likeComment', 'forum', 'like');
