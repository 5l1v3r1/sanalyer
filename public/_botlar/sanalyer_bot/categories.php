...
$link = "https://www.sanalyer.com/categories.php";	
...
foreach($sanalyer as $mydata) 
{
	 ...
	 $parent_id = $sanalyer_array[$i][0] = $mydata->parent_id; 
	 ...
	 $design = $sanalyer_array[$i][0] = addslashes($mydata->design); 
	 $created_at = $sanalyer_array[$i][0] = $mydata->created_at; 

	 $insert = $baglan->query("INSERT INTO categories SET
		id = '$id',
		parent_id = '$parent_id',
		title = '$title',
		content = '$content',
