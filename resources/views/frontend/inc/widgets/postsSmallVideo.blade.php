    ...
    <div class="content-timeline--right">
        <div class="content-timeline__media">
            <a href="{{ route('show_video',str_slug($item->title).'-'.$item->id) }}">
                ...
                <span class="content-timeline__media__icon"><i class="material-icons"></i></span>
            </a>
        </div>
        <div class="content-timeline__detail">
            <div class="content-timeline__detail__container">
                ...
                <div class="content-timeline__detail--bottom">
                    <a class="content-timeline__detail__author hide-phone" title="{{ $item->user()->first()->firstname }}">
