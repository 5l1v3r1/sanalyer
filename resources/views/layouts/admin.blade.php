...
<head>
    ...
    <title>@yield('title') Sanalyer Admin</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('home') }}" class="nav-link" target="_blank">Siteyi Görüntüle</a>
            </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="#" class="dropdown-item dropdown-footer">Diğer Bildirimler</a>
                </div>
            </li>
            <li class="nav-item">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('admin::index') }}" class="brand-link">
            <img src="{{ asset('admin/dist/img/AdminLTELogo.png') }}" alt="Sanalyer Admin" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Sanalyer Admin</span>
        </a>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin::comments',1) }}" class="nav-link">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>Onaylı Yorumlar</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin::comments',0) }}" class="nav-link">
                                    <i class="fa fa-circle-o nav-icon"></i>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2014-2018 <a href="https://www.radkod.com" target="_blank">RadKod</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
